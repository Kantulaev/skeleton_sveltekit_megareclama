...
>
  <div class="relative block h-96 col-span-2 lg:h-full">
    <iframe
      ...
      src="https://www.google.com/maps/embed?pb=!4v1671367982778!6m8!1m7!1sWm6ZO4Qyxam6BzPHBsMSkQ!2m2!1d42.97893421849219!2d47.47757814683744!3f233.47000346274683!4f16.000524021358217!5f0.7820865974627469"
      style="border:0;"
  ...
  <div class="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
    <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
      <div>
        ...
        <ul class="flex gap-2 mt-8 align-baseline">
          <li>
            <a
